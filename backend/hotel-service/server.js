...
try {
    ...
    if (fs.existsSync(secretFilePath)) {
        console.log("🔹 Hotel: Loading Key from Secret File...");
        serviceAccount = require(secretFilePath);
    } else {
        console.log("🔹 Hotel: Loading Key from Local File...");
    ...
    console.warn("⚠️  WARNING: Could not connect to Firebase.", error.message);
}
